...
<div className="card" style={{cursor:"pointer"}} >
  ...
  <img onClick={()=>navigate('/project/'+item._id)} src={item.photo} style={{height:"90%",width:"290px",marginTop:"1vh"}}  alt="project img" />
  </div>
        ...
        <div>
          ...
          
          {
            ...
            <FaHeart id='like-button' size={25} onClick={()=>dislikePost(item._id)}/>:
          <FaRegHeart size={25} onClick={()=>likePost(item._id)}/>:
          <h6>Login to like</h6>
          }
...
{
  visible<data.length?<button id='show__more-button' onClick={()=>showMoreItems()} >Load More...</button>:<></>
}
