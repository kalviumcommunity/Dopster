  ...
  return (
    <>
      ...
      <div className="contact" id="contact-us" style={{ minHeight: "70vh" }}>
        <h2>Contact Us</h2>
        <p>
          We appreciate your interest in Dopster and would love to hear from
          you! If you have any questions, concerns, or feedback, please don't
        ...
        <p>
          ...
          and will do our best to respond to your inquiry as soon as possible.
        </p>
